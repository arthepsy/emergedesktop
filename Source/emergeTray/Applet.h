...
public:
  ...
  LRESULT ModifyTrayIcon(HWND hwnd, UINT uID, UINT uFlags, UINT uCallbackMessage, HICON icon, LPTSTR newTip, bool hidden, bool shared);
  LRESULT SetTrayIconVersion(HWND hwnd, UINT uID, UINT iconVersion);
  LRESULT AddTrayIcon(HWND hwnd, UINT uID, UINT uFlags, UINT uCallbackMessage, HICON icon, LPTSTR szTip, bool hidden, bool shared);
