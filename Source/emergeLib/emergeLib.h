...
DLL_EXPORT bool ELRelativePathFromAbsPath(WCHAR *destPath, size_t destLength, LPCTSTR sourcePath = TEXT("%AppletDir%\\"));
DLL_EXPORT bool ELAbsPathFromRelativePath(WCHAR *destPath, size_t destLength, LPCTSTR sourcePath = TEXT("%AppletDir%\\"));
