...
DLL_EXPORT std::wstring ELRelativePathFromAbsPath(std::wstring destPath, LPCTSTR sourcePath = TEXT("%AppletDir%\\"));
DLL_EXPORT std::wstring ELAbsPathFromRelativePath(std::wstring destPath, LPCTSTR sourcePath = TEXT("%AppletDir%\\"));
