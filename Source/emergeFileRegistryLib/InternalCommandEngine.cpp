...
bool RegisterInternalCommand(int commandValue, std::wstring commandName, COMMANDHANDLERPROC commandHandler)
{
...
bool IsInternalCommand(std::wstring commandName)
{
  return (GetInternalCommandValue(commandName) != INVALID_COMMAND);
}

std::wstring GetInternalCommandName(int commandValue)
{
...
int GetInternalCommandValue(std::wstring commandName)
{
  std::vector<CommandHandler*>::iterator tempIter;
  CommandHandler* tempValue;
...
COMMANDHANDLERPROC GetCommandHandlerCallback(std::wstring commandName)
{
  ...
  commandValue = GetInternalCommandValue(commandName);
...
bool ExecuteInternalCommand(std::wstring commandName, std::wstring arguments)
{
...
bool PopulateInternalCommandList(HWND hwnd)
{
  std::vector<CommandHandler*>::iterator tempIter;
  CommandHandler* tempValue;
