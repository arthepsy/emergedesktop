...
#ifdef EMERGEFILEREGISTRYLIB_EXPORTS
#undef DLL_EXPORT
...
DLL_EXPORT std::wstring ELGetUNCFromMap(std::wstring uncMap, size_t uncLength);
...
DLL_EXPORT bool RegisterInternalCommand(std::wstring commandName, int commandValue, COMMANDHANDLERPROC commandHandler);
DLL_EXPORT bool IsInternalCommand(std::wstring commandName);
DLL_EXPORT std::wstring GetInternalCommandName(int commandValue);
DLL_EXPORT int GetInternalCommandValue(std::wstring commandName);
DLL_EXPORT bool ExecuteInternalCommand(std::wstring commandName, std::wstring arguments);
DLL_EXPORT bool PopulateInternalCommandList(HWND hwnd);
